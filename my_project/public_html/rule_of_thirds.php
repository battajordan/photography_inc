...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title> Rule of Thirds - Photography Inc.  </title>
    ...
    <?php include '../Resources/navigation.php'; ?>
        ...
        <h1 class="below_menu_container"> Rule of Thirds </h1>    

        <img class="image" src="img/ruleOfThirds.png" alt="Rule of Thirds Diagram" /> 
        <img class="image" src="img/horse_carriage_thirds.jpg" alt="Rule of Thirds on Picture" />
